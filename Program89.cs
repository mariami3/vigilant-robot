...
namespace ПР8 // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                {
                    user = new ClassUser();
                    users.Add(user); //Добавляет элемент в список
                    user.Name = Name;
                ...
                ТекстДляВводаПользователем = "Пользователь";
                ...
                while (true)
                {
                    ...
                    if (КоличествоПравильноВведенныхСимволов == ТекстДляВводаПользователем.Length)
                    {
                        ...
                        ТаблицаРекордов.ВыводРекордов(users);// вызов функции
    ...
    static internal class ТаблицаРекордов
    {
        public static void ВыводРекордов(List<ClassUser> users) //объявление функции
        {
            for (int i = 0; i<users.Count; i = i + 1)
                        {
